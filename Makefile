...
GD_LDFLAGS = -L/usr/lib/x86_64-linux-gnu -L/usr/lib/x86_64-linux-gnu -Wl,-Bsymbolic-functions
...
ROOTCFLAGS = -I/usr/local/include/root
...
ROOTLDFLAGS = -L/usr/local/lib/root -lRoot -lpcre -lncurses -lz -ldl
